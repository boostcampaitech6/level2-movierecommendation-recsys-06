...
class SASRecDataset_slide(Dataset):
    def __init__(self, args, user_windows, user_items, test_neg_items=None, data_type="train"):
        self.args = args
    ...
    def __getitem__(self, index):
        ...
        user_id = index
        items = self.user_windows[index]
        dicts = self.user_items[index]
    ...
    def __len__(self):
        return len(self.user_windows)

                
class SASRecDataset_neg(Dataset):
    def __init__(self, args, user_seq, test_neg_items=None, data_type="train"):
        self.args = args
        self.user_seq = user_seq
        self.test_neg_items = test_neg_items
